<script lang="ts">
// import SinglePostLayout from '@/layouts/SinglePostLayout.vue'
...
export default {
  ...
  computed: {
    ...
    selectPost() {
      return this._posts.find((post) => post.id === Number(this.$route.params.id))
    },
      ...
      <div class="row">
        <div class="inner_blog">
          ...
          <div class="single_post" id="scroll-target-1">
            ...
            <nav aria-label="breadcrumb" v-for="category in _categories" :key="category.id">
